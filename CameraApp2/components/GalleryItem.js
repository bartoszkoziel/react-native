...
export default function GalleryItem (props) {
  ...
  const body = (isSelected)
    ...
    : (
      <TouchableOpacity style={styles.container2} delayLongPress={300} onLongPress={() => { props.selectImg(assets.id) }} onPress={() => {props.imgView(assets.uri, assets.id, assets.height, assets.width)}}>
